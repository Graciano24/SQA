                ...
                <div class="listPembelajaran">
                    <a href="./bukuMatematika.html">
                        <div class="pembelajaran">
                            <img src="./img/keys.avif" width="512" height="512" alt="ikon pembelajaran" loading="lazy">
                            <div class="detail">
                    ...
                    <a href="./bukuSejarah.html">
                        <div class="pembelajaran">
                            <img src="./img/history.avif" width="512" height="512" alt="ikon pembelajaran" loading="lazy">
                            <div class="detail">
                    ...
                    <a href="./bukuSains.html">
                        <div class="pembelajaran">
                            <img src="./img/science.avif" width="512" height="512" alt="ikon pembelajaran" loading="lazy">
                            <div class="detail">
                    ...
                    <a href="./bukuUmum.html">
                        <div class="pembelajaran">
                            <img src="./img/alphabet.avif" width="512" height="512" alt="ikon pembelajaran">
                            <div class="detail">
