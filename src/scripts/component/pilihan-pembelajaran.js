            ...
            <div class="pilihanPembelajaran" id="pilihanPembelajaran">
                ...
                <div class="listPembelajaran">
                    ...
                    <a href="./bukuSejarah.html">
                        <div class="pembelajaran">
                            <img src="./img/history.avif" width="200" height="100" alt="ikon pembelajaran" loading="lazy">
                            <div class="detail">
                    ...
                    <a href="./bukuSains.html">
                        <div class="pembelajaran">
                            <img src="./img/science.avif" width="200" height="100" alt="ikon pembelajaran" loading="lazy">
                            <div class="detail">
                    ...
                    <a href="./bukuUmum.html">
                        <div class="pembelajaran">
                            <img src="./img/alphabet.avif" width="200" height="100" alt="ikon pembelajaran">
                            <div class="detail">
